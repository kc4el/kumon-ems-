...
class Department(models.Model):
    ...
    # FIX: Use a ForeignKey instead of a raw UUIDField for database integrity
...
class Message(models.Model):
    ...
    attachment = models.FileField(upload_to='message-attachments/%Y/%m/%d/', blank=True, null=True)
    created_at = models.DateTimeField(auto_now_add=True)
