"""
Django settings for kumon_ems project.
...
WSGI_APPLICATION = 'kumon_ems.wsgi.application'


# Database
# https://docs.djangoproject.com/en/6.1/ref/settings/#databases

if os.getenv('USE_SQLITE', 'true').strip().lower() in {'1', 'true', 'yes', 'on'}:
    DATABASES = {
        'default': {
